...
export interface Usage {
  ...
  /**
   * Number of tokens in the prompt that hits the context cache (DeepSeek-specific).
   */
  prompt_cache_hit_tokens?: number
  /**
   * Number of tokens in the prompt that misses the context cache (DeepSeek-specific).
   */
